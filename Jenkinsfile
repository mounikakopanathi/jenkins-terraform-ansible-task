    ...
    stages {
        ...
        stage('Checkout') {
            steps {
               ...
               sh 'git clone https://github.com/mounikakopanathi/jenkins-terraform-ansible-task.git'
            }
        }
        ...
        stage('Terraform Apply') {
            steps {
                script {
                    dir('/var/lib/jenkins/workspace/ansible-tf/ansible-task/jenkins-terraform-ansible-task') {
                    sh 'pwd'
                    sh 'terraform init'
